"""PerovskiteGPT v2 — FastAPI server entry point.
...
async def lifespan(app: FastAPI):
    logger.info("PerovskiteGPT v2 starting up...")
    yield
    logger.info("PerovskiteGPT v2 shutting down.")

app = FastAPI(title="PerovskiteGPT v2 — Agentic RAG", lifespan=lifespan)
...
if __name__ == "__main__":
    import uvicorn
    logger.info(f"Starting PerovskiteGPT v2 on {HOST}:{PORT}")
